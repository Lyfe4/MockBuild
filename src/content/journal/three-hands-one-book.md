---
title: Three hands, one book
date: 2026-06-02
season: winter
speciesId: carabus-violaceus
---
...
[_Carabus violaceus_](/specimen/carabus-violaceus) also gave us the one thing
the small references could not: room. The figure runs four hundred pixels from
mandible to elytral apex with all six legs clear of the body and the antennae
drawn segment by segment. The violet margin — the character the whole animal is
named for — reads as a band along the edge of each case rather than as a
highlight, which is precisely what a plate can carry and a photograph cannot.

Two more in this manner and the archive will have a school.
